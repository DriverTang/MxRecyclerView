...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public void setState(int state) {
        ...
        } else if (state == STATE_COMPLETE || state == STATE_ERROE) {
            mArrowImageView.setVisibility(View.INVISIBLE);
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.refresh_normal);
                break;
            ...
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    ...
                    mStatusTextView.setText(R.string.refresh_release);
                }
                break;
            ...
            case STATE_COMPLETE:
                mStatusTextView.setText(R.string.refresh_complete);
